...
# Selezione delle colonne da utilizzare come input e output
X = data.drop(columns=["target", "Indirizzo","Unnamed: 0"])
y = data["target"]


# Utilizzo della codifica Label Encoding per convertire le colonne con stringhe in valori numerici
...
# Aggiunta della seconda hidden layer con L2 regularization
